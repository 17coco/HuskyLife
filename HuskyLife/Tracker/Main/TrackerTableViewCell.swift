...
class TrackerTableViewCell: UITableViewCell {
    ...
    func initConstraints(){
        NSLayoutConstraint.activate([
            ...
            labelName.widthAnchor.constraint(lessThanOrEqualTo: wrapperCellView.widthAnchor, constant: -16),
            
            progressView.topAnchor.constraint(equalTo: labelName.bottomAnchor, constant: 8),
            ...
            progressView.widthAnchor.constraint(lessThanOrEqualTo: wrapperCellView.widthAnchor),
            
            labelHours.topAnchor.constraint(equalTo: progressView.bottomAnchor, constant: 8),
            ...
            labelHours.widthAnchor.constraint(lessThanOrEqualTo: wrapperCellView.widthAnchor),
            ...
            wrapperCellView.heightAnchor.constraint(equalToConstant: 107)
        ])
    }
